...
const ClientLectureRoom = () => {
    ...
    return (
        <div>            
            ...
            <div className="m-4">
                <div className="font-size-20 text-warning fw-semibold"> 현재 수강중인 강의 </div>
                    <div className="card mt-3 client-card col-lg-3 bg-info">                        
            ...
            <div className="m-4">
                <div className="font-size-20 text-success fw-semibold"> 수강이 종료된 강의 </div>
                    ...
                    <div className="card mt-3 client-card bg-soft bg-danger col-lg-3">                        
                        <div className="card-body">
                            <div className="text-white justify-content-between align-middle" style={{display:'flex'}}>
                                <div>
